          ...
          {menuItems.map((item) => {
            ...
            return (
              <Button
                ...
                className={`w-full justify-start mb-2 ${isSidebarCollapsed ? 'px-2' : ''} ${theme === 'dark' ? (isActive ? 'text-white' : 'text-gray-100') + ' hover:bg-gray-700' : (isActive ? 'text-white' : 'text-gray-900') + ' hover:bg-gray-100'}`}
